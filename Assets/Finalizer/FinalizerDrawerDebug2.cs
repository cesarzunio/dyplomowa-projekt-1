...
public sealed unsafe class FinalizerDrawerDebug2 : MonoBehaviour
{
...
[CustomEditor(typeof(FinalizerDrawerDebug2))]
public sealed class FinalizerDrawerDebugEditor2 : Editor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
        var fd = (FinalizerDrawerDebug2)target;
